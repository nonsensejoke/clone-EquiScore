...
#------------------------------------------------------
valid_keys =glob.glob(base_path+'training_data/PDBscreen/PDBscreen_HQ_active_pocket/*')
active_pros = set([v.split('/')[-1].split('_')[0] for v in valid_keys])

print('HQ actives pros :',len(active_pros))
cross_decoys= os.listdir(base_path+'training_data/PDBscreen/PDBscreen_HQ_cross_decoy_pocket/')

cross_decoys_pros = set([v.split('/')[-1].split('_')[0] for v in cross_decoys])
print('cross_decoys pros :',len(cross_decoys_pros))
cross_decoys_dir = base_path+'training_data/PDBscreen/PDBscreen_HQ_cross_decoy_pocket/'
...
cross_decoys_dir_pose = base_path+'training_data/PDBscreen/PDBscreen_HQ_active_augment_2a_pose_pocket/'
poses = os.listdir(base_path+'training_data/PDBscreen/PDBscreen_HQ_active_augment_2a_pose_pocket/')
...
valid_keys_decoys = glob.glob(base_path+'training_data/PDBscreen/PDBscreen_HQ_generated_decoy_pocket/*')
...
valid_keys_screen = glob.glob(base_path+'training_data/PDBscreen/PDBscreen_LQ_active_pocket/*')
# filtering
...
cross_decoys_screen= os.listdir(base_path+'training_data/PDBscreen/PDBscreen_LQ_cross_decoy_pocket/')
...
cross_decoys_dir_screen = base_path+'training_data/PDBscreen/PDBscreen_LQ_cross_decoy_pocket/'
...
#-------------------------------------------------------------------------------
cross_decoys_dir_screen_pose = base_path+'training_data/PDBscreen/PDBscreen_LQ_active_augment_2a_pose_pocket/'
screen_poses = os.listdir(base_path+'training_data/PDBscreen/PDBscreen_LQ_active_augment_2a_pose_pocket/')
...
########################################################### generated decoys ##################
valid_keys_screen_shape = glob.glob(base_path+'training_data/PDBscreen/PDBscreen_LQ_generated_decoy_pocket/*')
